...
public class SentNotification {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("recieverUserId");
    ...
    openapiRequiredFields.add("recieverUserId");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("recieverUserId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `recieverUserId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("recieverUserId").toString()));
      }
