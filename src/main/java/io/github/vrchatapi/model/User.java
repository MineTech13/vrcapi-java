...
public class User {
  ...
  **/
  ...
  public User lastMobile(OffsetDateTime lastMobile) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Either a date-time or empty string.")
