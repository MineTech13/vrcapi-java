...
public class LimitedUser {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bio, bioLinks, currentAvatarImageUrl, currentAvatarThumbnailImageUrl, currentAvatarTags, developerType, displayName, fallbackAvatar, id, isFriend, lastPlatform, profilePicOverride, pronouns, status, statusDescription, tags, userIcon, username, location, friendKey, lastLogin);
  }
