...
public class GroupsApi {
     ...
     * @param addGroupGalleryImageRequest  (optional)
     ...
     * @param groupId Must be a valid group ID. (required)
     * @param banGroupMemberRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param groupId Must be a valid group ID. (required)
     * @param createGroupAnnouncementRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param groupId Must be a valid group ID. (required)
     * @param createGroupGalleryRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param groupId Must be a valid group ID. (required)
     * @param createGroupInviteRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> OK </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> User &lt;displayName&gt; is already invited </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Error response due to missing auth cookie. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Error response when trying to perform operations on a non-existing group. </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @param groupId Must be a valid group ID. (required)
     * @param createGroupRoleRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getGroupInvitesCall(String groupId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGroupInvitesValidateBeforeCall(String groupId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling getGroupInvites(Async)");
        }

        return getGroupInvitesCall(groupId, _callback);
     ...
     */
    public List<GroupMember> getGroupInvites(String groupId) throws ApiException {
        ApiResponse<List<GroupMember>> localVarResp = getGroupInvitesWithHttpInfo(groupId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<GroupMember>> getGroupInvitesWithHttpInfo(String groupId) throws ApiException {
        okhttp3.Call localVarCall = getGroupInvitesValidateBeforeCall(groupId, null);
        Type localVarReturnType = new TypeToken<List<GroupMember>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getGroupInvitesAsync(String groupId, final ApiCallback<List<GroupMember>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGroupInvitesValidateBeforeCall(groupId, _callback);
        Type localVarReturnType = new TypeToken<List<GroupMember>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getGroupMembersCall(String groupId, Integer n, Integer offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGroupMembersValidateBeforeCall(String groupId, Integer n, Integer offset, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling getGroupMembers(Async)");
        }

        return getGroupMembersCall(groupId, n, offset, _callback);
     ...
     */
    public List<GroupMember> getGroupMembers(String groupId, Integer n, Integer offset) throws ApiException {
        ApiResponse<List<GroupMember>> localVarResp = getGroupMembersWithHttpInfo(groupId, n, offset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<GroupMember>> getGroupMembersWithHttpInfo(String groupId, Integer n, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getGroupMembersValidateBeforeCall(groupId, n, offset, null);
        Type localVarReturnType = new TypeToken<List<GroupMember>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getGroupMembersAsync(String groupId, Integer n, Integer offset, final ApiCallback<List<GroupMember>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGroupMembersValidateBeforeCall(groupId, n, offset, _callback);
        Type localVarReturnType = new TypeToken<List<GroupMember>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getGroupRequestsCall(String groupId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGroupRequestsValidateBeforeCall(String groupId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'groupId' is set
        if (groupId == null) {
            throw new ApiException("Missing the required parameter 'groupId' when calling getGroupRequests(Async)");
        }

        return getGroupRequestsCall(groupId, _callback);
     ...
     */
    public List<GroupMember> getGroupRequests(String groupId) throws ApiException {
        ApiResponse<List<GroupMember>> localVarResp = getGroupRequestsWithHttpInfo(groupId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<GroupMember>> getGroupRequestsWithHttpInfo(String groupId) throws ApiException {
        okhttp3.Call localVarCall = getGroupRequestsValidateBeforeCall(groupId, null);
        Type localVarReturnType = new TypeToken<List<GroupMember>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getGroupRequestsAsync(String groupId, final ApiCallback<List<GroupMember>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGroupRequestsValidateBeforeCall(groupId, _callback);
        Type localVarReturnType = new TypeToken<List<GroupMember>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param groupId Must be a valid group ID. (required)
     * @param userId Must be a valid user ID. (required)
     * @param respondGroupJoinRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
